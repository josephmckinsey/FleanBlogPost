...
#doc (Page) "An _Astounding_ Document" =>
...
There are references to {ref one}[one section] and {ref another}[another].
...
With a reference to {ref another}[the parent].
